...
function kube::deploy_apps {
    ...
    run_cmd "kubectl apply --validate=false -f 'https://github.com/jetstack/cert-manager/releases/download/v0.14.0/cert-manager.yaml'"
...
function kube::destroy_apps {
    ...
    run_cmd "kubectl delete -f 'https://github.com/jetstack/cert-manager/releases/download/v0.14.0/cert-manager.yaml' 2>/dev/null" "" false
