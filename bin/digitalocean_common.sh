...
function digitalocean::destroy_do_spaces_bucket {
    ...
    local cluster_cloud_region=$1
    run_cmd "s3cmd rb \"s3://${DO_SPACES_BACKEND_BUCKET}\" --force --host="$cluster_cloud_region.digitaloceanspaces.com" --host-bucket="%(bucket)s.$cluster_cloud_region.digitaloceanspaces.com""
}
